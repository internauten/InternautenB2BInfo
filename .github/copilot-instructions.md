# Copilot Instructions for InternautenB2BInfo
...
- This is a PrestaShop module with the module folder `InternautenB2BInfo`.
- Target platforms:
  - PrestaShop >= 9.1.4
  - PHP >= 8.3.31
...
- Keep the structure of the `InternautenB2BInfo` module folder consistent.
